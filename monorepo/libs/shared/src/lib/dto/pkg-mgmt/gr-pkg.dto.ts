...
import { ArrayMinSize, ArrayNotEmpty, IsEnum, IsObject, IsString, ValidateNested } from 'class-validator';
...
export class CreateGrReqDto {
  ...
  export class UpdateGrReqDto extends PickType(CreateGrReqDto, ['name', 'members'] as const) {}
